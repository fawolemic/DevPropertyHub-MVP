...
void main() {
  group('SubscriptionSelectionScreen', () {
    testWidgets('should display all subscription plans', (WidgetTester tester) async {
      ...
      expect(find.text('Select the subscription plan that best suits your needs'), findsOneWidget);
    ...
    testWidgets('should allow selecting a different plan', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(
        home: SubscriptionSelectionScreen(),
      ));
    ...
    testWidgets('should show snackbar when proceeding to payment', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(
        home: SubscriptionSelectionScreen(),
      ));
      ...
      expect(find.text('Proceeding to payment for premium plan'), findsOneWidget);
    });
    
    testWidgets('should show snackbar when skipping subscription', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(
        home: SubscriptionSelectionScreen(),
      ));
