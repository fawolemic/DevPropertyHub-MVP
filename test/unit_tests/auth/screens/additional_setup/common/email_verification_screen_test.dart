...
void main() {
  group('EmailVerificationScreen', () {
    testWidgets('should display email address and verification fields', (WidgetTester tester) async {
    ...
    testWidgets('should show error when incomplete code is submitted', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: EmailVerificationScreen(
    ...
    testWidgets('should auto-advance focus when digit is entered', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: EmailVerificationScreen(
          email: 'test@example.com',
          onVerificationComplete: (_) {},
    ...
    testWidgets('should handle resend code button state', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: EmailVerificationScreen(
          email: 'test@example.com',
          onVerificationComplete: (_) {},
    ...
    testWidgets('should call onVerificationComplete when correct code is entered', (WidgetTester tester) async {
      bool verificationComplete = false;
      ...
      for (int i = 0; i < 6; i++) {
        await tester.enterText(find.byType(TextField).at(i), i == 0 ? '1' : (i == 1 ? '2' : (i == 2 ? '3' : (i == 3 ? '4' : (i == 4 ? '5' : '6')))));
      }
