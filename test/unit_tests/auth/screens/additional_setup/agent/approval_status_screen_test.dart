...
void main() {
  group('ApprovalStatusScreen', () {
    testWidgets('displays all approval status components correctly', (WidgetTester tester) async {
      // Build the widget
    ...
    testWidgets('shows contact support dialog when button is tapped', (WidgetTester tester) async {
      // Build the widget
      await tester.pumpWidget(
        MaterialApp(
          home: ApprovalStatusScreen(agentName: 'Test Agent'),
      ...
      expect(find.text('Our support team is available to help you with any questions about your agent application.'), findsNothing);
    });
    
    testWidgets('shows upload documents dialog when button is tapped', (WidgetTester tester) async {
      // Build the widget
      await tester.pumpWidget(
        MaterialApp(
          home: ApprovalStatusScreen(agentName: 'Test Agent'),
      ...
      expect(find.text('If you\'ve been asked to provide additional documentation for your application, you can upload it here.'), findsOneWidget);
