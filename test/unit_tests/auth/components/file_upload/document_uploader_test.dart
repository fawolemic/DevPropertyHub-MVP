...
void main() {
  group('DocumentUploader', () {
    testWidgets('should render upload button initially',
      ...
      expect(find.text('Accepted file types: pdf, jpg, png. Max size: 5MB'),
          findsOneWidget);
    ...
    testWidgets('should show progress indicator during upload',
        (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: DocumentUploader(
    ...
    testWidgets('should display file preview after upload completes',
        (WidgetTester tester) async {
      String? selectedFile;
